...
Google::Protobuf::DescriptorPool.generated_pool.build do
  ...
  add_message "gitaly.ListCommitsRequest" do
    oneof :payload do
      optional :header, :message, 1, "gitaly.ListCommitsRequest.Header"
      optional :revision, :bytes, 2
    end
  end
  add_message "gitaly.ListCommitsRequest.Header" do
    optional :repository, :message, 1, "gitaly.Repository"
  end
...
module Gitaly
  ...
  ListCommitsRequest::Header = Google::Protobuf::DescriptorPool.generated_pool.lookup("gitaly.ListCommitsRequest.Header").msgclass
