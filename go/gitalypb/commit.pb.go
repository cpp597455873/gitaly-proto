...
type BatchFindCommitRequest struct {
	Repository *Repository `protobuf:"bytes,1,opt,name=repository" json:"repository,omitempty"`
	Revisions  [][]byte    `protobuf:"bytes,2,rep,name=revisions,proto3" json:"revisions,omitempty"`
}

func (m *BatchFindCommitRequest) Reset()                    { *m = BatchFindCommitRequest{} }
func (m *BatchFindCommitRequest) String() string            { return proto.CompactTextString(m) }
func (*BatchFindCommitRequest) ProtoMessage()               {}
func (*BatchFindCommitRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{19} }

func (m *BatchFindCommitRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *BatchFindCommitRequest) GetRevisions() [][]byte {
	if m != nil {
		return m.Revisions
	}
	return nil
...
type BatchFindCommitResponse struct {
	// nil when the commit was not found
	Commits []*GitCommit `protobuf:"bytes,1,rep,name=commits" json:"commits,omitempty"`
}

func (m *BatchFindCommitResponse) Reset()                    { *m = BatchFindCommitResponse{} }
func (m *BatchFindCommitResponse) String() string            { return proto.CompactTextString(m) }
func (*BatchFindCommitResponse) ProtoMessage()               {}
func (*BatchFindCommitResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{20} }

func (m *BatchFindCommitResponse) GetCommits() []*GitCommit {
	if m != nil {
		return m.Commits
	}
	return nil
...
func (*ListCommitsByOidRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{21} }
...
func (*ListCommitsByOidResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{22} }
...
func (*FindAllCommitsRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{23} }
...
func (*FindAllCommitsResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{24} }
...
func (*FindCommitsRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{25} }
...
func (*FindCommitsResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{26} }
...
func (*CommitLanguagesRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{27} }
...
func (*CommitLanguagesResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{28} }
...
func (*RawBlameRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{29} }
...
func (*RawBlameResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{30} }
...
func (*LastCommitForPathRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{31} }
...
func (*LastCommitForPathResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{32} }
...
func (*ListLastCommitsForTreeRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{33} }
...
func (*ListLastCommitsForTreeResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{34} }
...
func (*CommitsByMessageRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{35} }
...
func (*CommitsByMessageResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{36} }
...
func (*ExtractCommitSignatureRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{39} }
...
func (*ExtractCommitSignatureResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{40} }
...
func (*GetCommitSignaturesRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{41} }
...
func (*GetCommitSignaturesResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{42} }
...
func (*GetCommitMessagesRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{43} }
...
func (*GetCommitMessagesResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{44} }
...
func init() {
	...
	proto.RegisterType((*BatchFindCommitRequest)(nil), "gitaly.BatchFindCommitRequest")
	proto.RegisterType((*BatchFindCommitResponse)(nil), "gitaly.BatchFindCommitResponse")
...
type CommitServiceClient interface {
	...
	BatchFindCommit(ctx context.Context, in *BatchFindCommitRequest, opts ...grpc.CallOption) (CommitService_BatchFindCommitClient, error)
...
func (c *commitServiceClient) BatchFindCommit(ctx context.Context, in *BatchFindCommitRequest, opts ...grpc.CallOption) (CommitService_BatchFindCommitClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[4], c.cc, "/gitaly.CommitService/BatchFindCommit", opts...)
	if err != nil {
		return nil, err
	}
	x := &commitServiceBatchFindCommitClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CommitService_BatchFindCommitClient interface {
	Recv() (*BatchFindCommitResponse, error)
	grpc.ClientStream
}

type commitServiceBatchFindCommitClient struct {
	grpc.ClientStream
}

func (x *commitServiceBatchFindCommitClient) Recv() (*BatchFindCommitResponse, error) {
	m := new(BatchFindCommitResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *commitServiceClient) FindAllCommits(ctx context.Context, in *FindAllCommitsRequest, opts ...grpc.CallOption) (CommitService_FindAllCommitsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[5], c.cc, "/gitaly.CommitService/FindAllCommits", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) FindCommits(ctx context.Context, in *FindCommitsRequest, opts ...grpc.CallOption) (CommitService_FindCommitsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[6], c.cc, "/gitaly.CommitService/FindCommits", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) RawBlame(ctx context.Context, in *RawBlameRequest, opts ...grpc.CallOption) (CommitService_RawBlameClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[7], c.cc, "/gitaly.CommitService/RawBlame", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) ListLastCommitsForTree(ctx context.Context, in *ListLastCommitsForTreeRequest, opts ...grpc.CallOption) (CommitService_ListLastCommitsForTreeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[8], c.cc, "/gitaly.CommitService/ListLastCommitsForTree", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) CommitsByMessage(ctx context.Context, in *CommitsByMessageRequest, opts ...grpc.CallOption) (CommitService_CommitsByMessageClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[9], c.cc, "/gitaly.CommitService/CommitsByMessage", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) ListCommitsByOid(ctx context.Context, in *ListCommitsByOidRequest, opts ...grpc.CallOption) (CommitService_ListCommitsByOidClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[10], c.cc, "/gitaly.CommitService/ListCommitsByOid", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) FilterShasWithSignatures(ctx context.Context, opts ...grpc.CallOption) (CommitService_FilterShasWithSignaturesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[11], c.cc, "/gitaly.CommitService/FilterShasWithSignatures", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) ExtractCommitSignature(ctx context.Context, in *ExtractCommitSignatureRequest, opts ...grpc.CallOption) (CommitService_ExtractCommitSignatureClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[12], c.cc, "/gitaly.CommitService/ExtractCommitSignature", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) GetCommitSignatures(ctx context.Context, in *GetCommitSignaturesRequest, opts ...grpc.CallOption) (CommitService_GetCommitSignaturesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[13], c.cc, "/gitaly.CommitService/GetCommitSignatures", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *commitServiceClient) GetCommitMessages(ctx context.Context, in *GetCommitMessagesRequest, opts ...grpc.CallOption) (CommitService_GetCommitMessagesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[14], c.cc, "/gitaly.CommitService/GetCommitMessages", opts...)
	if err != nil {
		return nil, err
	}
...
type CommitServiceServer interface {
	...
	// Use a stream to paginate the result set
	BatchFindCommit(*BatchFindCommitRequest, CommitService_BatchFindCommitServer) error
...
func _CommitService_BatchFindCommit_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BatchFindCommitRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CommitServiceServer).BatchFindCommit(m, &commitServiceBatchFindCommitServer{stream})
}

type CommitService_BatchFindCommitServer interface {
	Send(*BatchFindCommitResponse) error
	grpc.ServerStream
}

type commitServiceBatchFindCommitServer struct {
	grpc.ServerStream
}

func (x *commitServiceBatchFindCommitServer) Send(m *BatchFindCommitResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _CommitService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "BatchFindCommit",
			Handler:       _CommitService_BatchFindCommit_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor2 = []byte{
	...
	,
}
