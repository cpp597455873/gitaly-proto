...
func (ObjectType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{0}
}
...
func (OperationMsg_Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{0, 0}
}
...
func (OperationMsg_Scope) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{0, 1}
}
...
func (*Repository) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{1}
}
...
func (*GitCommit) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{2}
}
...
func (*CommitAuthor) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{3}
}
...
func (*ExitStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{4}
}
...
func (*Branch) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{5}
}
...
type Ref struct {
	RefPath              []byte     `protobuf:"bytes,1,opt,name=ref_path,json=refPath,proto3" json:"ref_path,omitempty"`
	TargetCommit         *GitCommit `protobuf:"bytes,2,opt,name=target_commit,json=targetCommit,proto3" json:"target_commit,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
...
func (*Ref) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{6}
}
...
func (m *Ref) GetTargetCommit() *GitCommit {
	if m != nil {
		return m.TargetCommit
	}
	return nil
...
func (*Tag) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{7}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{8}
}
...
func (*ObjectPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_shared_247f3b887c6f61fd, []int{9}
}
...
func init() {
	...
	proto.RegisterType((*Ref)(nil), "gitaly.Ref")
...
func init() { proto.RegisterFile("shared.proto", fileDescriptor_shared_247f3b887c6f61fd) }

var fileDescriptor_shared_247f3b887c6f61fd = []byte{
	...
	,
}
