...
func (*ServerInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_server_167e111591f4941a, []int{0}
}
...
func (*ServerInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_server_167e111591f4941a, []int{1}
}
...
func (*ServerInfoResponse_StorageStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_server_167e111591f4941a, []int{1, 0}
}
...
func init() { proto.RegisterFile("server.proto", fileDescriptor_server_167e111591f4941a) }

var fileDescriptor_server_167e111591f4941a = []byte{
	// 345 bytes of a gzipped FileDescriptorProto
	,
}
