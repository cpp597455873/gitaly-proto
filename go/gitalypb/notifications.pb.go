...
func (*PostReceiveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_notifications_451d9360941a9e70, []int{0}
}
...
func (*PostReceiveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_notifications_451d9360941a9e70, []int{1}
}
...
func init() { proto.RegisterFile("notifications.proto", fileDescriptor_notifications_451d9360941a9e70) }

var fileDescriptor_notifications_451d9360941a9e70 = []byte{
	...
	0xd8, 0xc0, 0x1e, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xa5, 0xb9, 0xed, 0xe4, 0xfd, 0x00,
	0x00, 0x00,
}
