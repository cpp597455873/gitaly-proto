...
type ListShasWithSignaturesRequest struct {
	Repository *Repository `protobuf:"bytes,1,opt,name=repository" json:"repository,omitempty"`
	Shas       [][]byte    `protobuf:"bytes,2,rep,name=shas,proto3" json:"shas,omitempty"`
}

func (m *ListShasWithSignaturesRequest) Reset()                    { *m = ListShasWithSignaturesRequest{} }
func (m *ListShasWithSignaturesRequest) String() string            { return proto.CompactTextString(m) }
func (*ListShasWithSignaturesRequest) ProtoMessage()               {}
func (*ListShasWithSignaturesRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{31} }

func (m *ListShasWithSignaturesRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *ListShasWithSignaturesRequest) GetShas() [][]byte {
	if m != nil {
		return m.Shas
	}
	return nil
...
type ListShasWithSignaturesResponse struct {
	Signatures []*ListShasWithSignaturesResponse_GitSignature `protobuf:"bytes,1,rep,name=signatures" json:"signatures,omitempty"`
}

func (m *ListShasWithSignaturesResponse) Reset()                    { *m = ListShasWithSignaturesResponse{} }
func (m *ListShasWithSignaturesResponse) String() string            { return proto.CompactTextString(m) }
func (*ListShasWithSignaturesResponse) ProtoMessage()               {}
func (*ListShasWithSignaturesResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{32} }

func (m *ListShasWithSignaturesResponse) GetSignatures() []*ListShasWithSignaturesResponse_GitSignature {
	if m != nil {
		return m.Signatures
	}
	return nil
...
type ListShasWithSignaturesResponse_GitSignature struct {
	Signature  []byte `protobuf:"bytes,1,opt,name=signature,proto3" json:"signature,omitempty"`
	SignedData []byte `protobuf:"bytes,2,opt,name=signed_data,json=signedData,proto3" json:"signed_data,omitempty"`
}

func (m *ListShasWithSignaturesResponse_GitSignature) Reset() {
	*m = ListShasWithSignaturesResponse_GitSignature{}
}
func (m *ListShasWithSignaturesResponse_GitSignature) String() string {
	return proto.CompactTextString(m)
}
func (*ListShasWithSignaturesResponse_GitSignature) ProtoMessage() {}
func (*ListShasWithSignaturesResponse_GitSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor1, []int{32, 0}
}

func (m *ListShasWithSignaturesResponse_GitSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *ListShasWithSignaturesResponse_GitSignature) GetSignedData() []byte {
	if m != nil {
		return m.SignedData
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ListShasWithSignaturesRequest)(nil), "gitaly.ListShasWithSignaturesRequest")
	proto.RegisterType((*ListShasWithSignaturesResponse)(nil), "gitaly.ListShasWithSignaturesResponse")
	proto.RegisterType((*ListShasWithSignaturesResponse_GitSignature)(nil), "gitaly.ListShasWithSignaturesResponse.GitSignature")
...
type CommitServiceClient interface {
	...
	ListShasWithSignatures(ctx context.Context, opts ...grpc.CallOption) (CommitService_ListShasWithSignaturesClient, error)
}
...
func (c *commitServiceClient) ListShasWithSignatures(ctx context.Context, opts ...grpc.CallOption) (CommitService_ListShasWithSignaturesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[9], c.cc, "/gitaly.CommitService/ListShasWithSignatures", opts...)
	if err != nil {
		return nil, err
	}
	x := &commitServiceListShasWithSignaturesClient{stream}
	return x, nil
}

type CommitService_ListShasWithSignaturesClient interface {
	Send(*ListShasWithSignaturesRequest) error
	Recv() (*ListShasWithSignaturesResponse, error)
	grpc.ClientStream
}

type commitServiceListShasWithSignaturesClient struct {
	grpc.ClientStream
}

func (x *commitServiceListShasWithSignaturesClient) Send(m *ListShasWithSignaturesRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *commitServiceListShasWithSignaturesClient) Recv() (*ListShasWithSignaturesResponse, error) {
	m := new(ListShasWithSignaturesResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type CommitServiceServer interface {
	...
	ListShasWithSignatures(CommitService_ListShasWithSignaturesServer) error
}
...
func _CommitService_ListShasWithSignatures_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CommitServiceServer).ListShasWithSignatures(&commitServiceListShasWithSignaturesServer{stream})
}

type CommitService_ListShasWithSignaturesServer interface {
	Send(*ListShasWithSignaturesResponse) error
	Recv() (*ListShasWithSignaturesRequest, error)
	grpc.ServerStream
}

type commitServiceListShasWithSignaturesServer struct {
	grpc.ServerStream
}

func (x *commitServiceListShasWithSignaturesServer) Send(m *ListShasWithSignaturesResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *commitServiceListShasWithSignaturesServer) Recv() (*ListShasWithSignaturesRequest, error) {
	m := new(ListShasWithSignaturesRequest)
...
var _CommitService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ListShasWithSignatures",
			Handler:       _CommitService_ListShasWithSignatures_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
var fileDescriptor1 = []byte{
	...
	,
}
