...
type ListTreeEntriesRequest struct {
	Repository *Repository                          `protobuf:"bytes,1,opt,name=repository" json:"repository,omitempty"`
	CommitBlob *ListTreeEntriesRequest_RevisionPath `protobuf:"bytes,2,opt,name=commit_blob,json=commitBlob" json:"commit_blob,omitempty"`
	Limit      int64                                `protobuf:"varint,3,opt,name=limit" json:"limit,omitempty"`
}

func (m *ListTreeEntriesRequest) Reset()                    { *m = ListTreeEntriesRequest{} }
func (m *ListTreeEntriesRequest) String() string            { return proto.CompactTextString(m) }
func (*ListTreeEntriesRequest) ProtoMessage()               {}
func (*ListTreeEntriesRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{33} }

func (m *ListTreeEntriesRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *ListTreeEntriesRequest) GetCommitBlob() *ListTreeEntriesRequest_RevisionPath {
	if m != nil {
		return m.CommitBlob
	}
	return nil
...
func (m *ListTreeEntriesRequest) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
type ListTreeEntriesRequest_RevisionPath struct {
	// commit ID
...
func (m *ListTreeEntriesRequest_RevisionPath) Reset()         { *m = ListTreeEntriesRequest_RevisionPath{} }
func (m *ListTreeEntriesRequest_RevisionPath) String() string { return proto.CompactTextString(m) }
func (*ListTreeEntriesRequest_RevisionPath) ProtoMessage()    {}
func (*ListTreeEntriesRequest_RevisionPath) Descriptor() ([]byte, []int) {
	return fileDescriptor1, []int{33, 0}
}

func (m *ListTreeEntriesRequest_RevisionPath) GetOid() []byte {
	if m != nil {
		return m.Oid
	}
	return nil
...
func (m *ListTreeEntriesRequest_RevisionPath) GetPath() []byte {
	if m != nil {
		return m.Path
	}
	return nil
...
type ListTreeEntriesResponse struct {
...
func (m *ListTreeEntriesResponse) Reset()                    { *m = ListTreeEntriesResponse{} }
func (m *ListTreeEntriesResponse) String() string            { return proto.CompactTextString(m) }
func (*ListTreeEntriesResponse) ProtoMessage()               {}
func (*ListTreeEntriesResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{34} }

func (m *ListTreeEntriesResponse) GetSize() int64 {
	if m != nil {
		return m.Size
	}
	return 0
...
func (m *ListTreeEntriesResponse) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *ListTreeEntriesResponse) GetOid() string {
	if m != nil {
		return m.Oid
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ListTreeEntriesRequest)(nil), "gitaly.ListTreeEntriesRequest")
	proto.RegisterType((*ListTreeEntriesRequest_RevisionPath)(nil), "gitaly.ListTreeEntriesRequest.RevisionPath")
	proto.RegisterType((*ListTreeEntriesResponse)(nil), "gitaly.ListTreeEntriesResponse")
...
type CommitServiceClient interface {
	...
	ListTreeEntries(ctx context.Context, in *ListTreeEntriesRequest, opts ...grpc.CallOption) (CommitService_ListTreeEntriesClient, error)
...
func (c *commitServiceClient) ListTreeEntries(ctx context.Context, in *ListTreeEntriesRequest, opts ...grpc.CallOption) (CommitService_ListTreeEntriesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[9], c.cc, "/gitaly.CommitService/ListTreeEntries", opts...)
	if err != nil {
		return nil, err
	}
	x := &commitServiceListTreeEntriesClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CommitService_ListTreeEntriesClient interface {
	Recv() (*ListTreeEntriesResponse, error)
	grpc.ClientStream
}

type commitServiceListTreeEntriesClient struct {
	grpc.ClientStream
}

func (x *commitServiceListTreeEntriesClient) Recv() (*ListTreeEntriesResponse, error) {
	m := new(ListTreeEntriesResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type CommitServiceServer interface {
	...
	ListTreeEntries(*ListTreeEntriesRequest, CommitService_ListTreeEntriesServer) error
...
func _CommitService_ListTreeEntries_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListTreeEntriesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CommitServiceServer).ListTreeEntries(m, &commitServiceListTreeEntriesServer{stream})
}

type CommitService_ListTreeEntriesServer interface {
	Send(*ListTreeEntriesResponse) error
	grpc.ServerStream
}

type commitServiceListTreeEntriesServer struct {
	grpc.ServerStream
}

func (x *commitServiceListTreeEntriesServer) Send(m *ListTreeEntriesResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _CommitService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _CommitService_ListTreeEntries_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor1 = []byte{
	...
	,
}
