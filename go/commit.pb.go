...
func (*ListFilesRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{11} }
...
func (*ListFilesResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{12} }
...
func (*FindCommitRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{13} }
...
func (*FindCommitResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{14} }
...
var fileDescriptor1 = []byte{
	...
	,
}
