...
type LastCommitIdForPathRequest struct {
	Repository *Repository `protobuf:"bytes,1,opt,name=repository" json:"repository,omitempty"`
	Revision   []byte      `protobuf:"bytes,2,opt,name=revision,proto3" json:"revision,omitempty"`
	Path       []byte      `protobuf:"bytes,3,opt,name=path,proto3" json:"path,omitempty"`
}

func (m *LastCommitIdForPathRequest) Reset()                    { *m = LastCommitIdForPathRequest{} }
func (m *LastCommitIdForPathRequest) String() string            { return proto.CompactTextString(m) }
func (*LastCommitIdForPathRequest) ProtoMessage()               {}
func (*LastCommitIdForPathRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{23} }

func (m *LastCommitIdForPathRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *LastCommitIdForPathRequest) GetRevision() []byte {
	if m != nil {
		return m.Revision
	}
	return nil
...
func (m *LastCommitIdForPathRequest) GetPath() []byte {
	if m != nil {
		return m.Path
	}
	return nil
...
type LastCommitIdForPathResponse struct {
	// Empty if not found
	CommitId string `protobuf:"bytes,1,opt,name=commit_id,json=commitId" json:"commit_id,omitempty"`
}

func (m *LastCommitIdForPathResponse) Reset()                    { *m = LastCommitIdForPathResponse{} }
func (m *LastCommitIdForPathResponse) String() string            { return proto.CompactTextString(m) }
func (*LastCommitIdForPathResponse) ProtoMessage()               {}
func (*LastCommitIdForPathResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *LastCommitIdForPathResponse) GetCommitId() string {
	if m != nil {
		return m.CommitId
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*LastCommitIdForPathRequest)(nil), "gitaly.LastCommitIdForPathRequest")
	proto.RegisterType((*LastCommitIdForPathResponse)(nil), "gitaly.LastCommitIdForPathResponse")
...
type CommitServiceClient interface {
	...
	LastCommitIdForPath(ctx context.Context, in *LastCommitIdForPathRequest, opts ...grpc.CallOption) (*LastCommitIdForPathResponse, error)
}
...
func (c *commitServiceClient) LastCommitIdForPath(ctx context.Context, in *LastCommitIdForPathRequest, opts ...grpc.CallOption) (*LastCommitIdForPathResponse, error) {
	out := new(LastCommitIdForPathResponse)
	err := grpc.Invoke(ctx, "/gitaly.CommitService/LastCommitIdForPath", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommitServiceServer interface {
	...
	LastCommitIdForPath(context.Context, *LastCommitIdForPathRequest) (*LastCommitIdForPathResponse, error)
}
...
func _CommitService_LastCommitIdForPath_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LastCommitIdForPathRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommitServiceServer).LastCommitIdForPath(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitaly.CommitService/LastCommitIdForPath",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommitServiceServer).LastCommitIdForPath(ctx, req.(*LastCommitIdForPathRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CommitService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LastCommitIdForPath",
			Handler:    _CommitService_LastCommitIdForPath_Handler,
		},
	},
...
var fileDescriptor1 = []byte{
	...
	,
}
