...
type GetTreeEntriesBySelectorRequest struct {
	Repository *Repository `protobuf:"bytes,1,opt,name=repository" json:"repository,omitempty"`
	// We can't use repeated fields inside a oneof field, so we lay selectors out flat.
	// Optional selector: Object IDs.
	Oids string `protobuf:"bytes,2,opt,name=oids" json:"oids,omitempty"`
	// Optional selector: Revision/Path pairs.
	RevisionPaths *GetTreeEntriesBySelectorRequest_RevisionPath `protobuf:"bytes,3,opt,name=revision_paths,json=revisionPaths" json:"revision_paths,omitempty"`
	// Data limit (if any), 0 to return no data, -1 to return all data.
	Limit int64 `protobuf:"varint,4,opt,name=limit" json:"limit,omitempty"`
}

func (m *GetTreeEntriesBySelectorRequest) Reset()         { *m = GetTreeEntriesBySelectorRequest{} }
func (m *GetTreeEntriesBySelectorRequest) String() string { return proto.CompactTextString(m) }
func (*GetTreeEntriesBySelectorRequest) ProtoMessage()    {}
func (*GetTreeEntriesBySelectorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor1, []int{35}
}

func (m *GetTreeEntriesBySelectorRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *GetTreeEntriesBySelectorRequest) GetOids() string {
	if m != nil {
		return m.Oids
	}
	return ""
...
func (m *GetTreeEntriesBySelectorRequest) GetRevisionPaths() *GetTreeEntriesBySelectorRequest_RevisionPath {
	if m != nil {
...
func (m *GetTreeEntriesBySelectorRequest) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
type GetTreeEntriesBySelectorRequest_RevisionPath struct {
	Revision string `protobuf:"bytes,1,opt,name=revision" json:"revision,omitempty"`
	Path     []byte `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty"`
}

func (m *GetTreeEntriesBySelectorRequest_RevisionPath) Reset() {
	*m = GetTreeEntriesBySelectorRequest_RevisionPath{}
}
func (m *GetTreeEntriesBySelectorRequest_RevisionPath) String() string {
	return proto.CompactTextString(m)
}
func (*GetTreeEntriesBySelectorRequest_RevisionPath) ProtoMessage() {}
func (*GetTreeEntriesBySelectorRequest_RevisionPath) Descriptor() ([]byte, []int) {
	return fileDescriptor1, []int{35, 0}
}

func (m *GetTreeEntriesBySelectorRequest_RevisionPath) GetRevision() string {
	if m != nil {
		return m.Revision
	}
	return ""
...
func (m *GetTreeEntriesBySelectorRequest_RevisionPath) GetPath() []byte {
	if m != nil {
		return m.Path
	}
	return nil
...
type GetTreeEntriesBySelectorResponse struct {
	Entries []*TreeEntry `protobuf:"bytes,1,rep,name=entries" json:"entries,omitempty"`
}

func (m *GetTreeEntriesBySelectorResponse) Reset()         { *m = GetTreeEntriesBySelectorResponse{} }
func (m *GetTreeEntriesBySelectorResponse) String() string { return proto.CompactTextString(m) }
func (*GetTreeEntriesBySelectorResponse) ProtoMessage()    {}
func (*GetTreeEntriesBySelectorResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor1, []int{36}
}

func (m *GetTreeEntriesBySelectorResponse) GetEntries() []*TreeEntry {
	if m != nil {
		return m.Entries
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GetTreeEntriesBySelectorRequest)(nil), "gitaly.GetTreeEntriesBySelectorRequest")
	proto.RegisterType((*GetTreeEntriesBySelectorRequest_RevisionPath)(nil), "gitaly.GetTreeEntriesBySelectorRequest.RevisionPath")
	proto.RegisterType((*GetTreeEntriesBySelectorResponse)(nil), "gitaly.GetTreeEntriesBySelectorResponse")
...
type CommitServiceClient interface {
	...
	GetTreeEntriesBySelector(ctx context.Context, in *GetTreeEntriesBySelectorRequest, opts ...grpc.CallOption) (CommitService_GetTreeEntriesBySelectorClient, error)
...
func (c *commitServiceClient) GetTreeEntriesBySelector(ctx context.Context, in *GetTreeEntriesBySelectorRequest, opts ...grpc.CallOption) (CommitService_GetTreeEntriesBySelectorClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[3], c.cc, "/gitaly.CommitService/GetTreeEntriesBySelector", opts...)
	if err != nil {
		return nil, err
	}
	x := &commitServiceGetTreeEntriesBySelectorClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CommitService_GetTreeEntriesBySelectorClient interface {
	Recv() (*GetTreeEntriesBySelectorResponse, error)
	grpc.ClientStream
}

type commitServiceGetTreeEntriesBySelectorClient struct {
	grpc.ClientStream
}

func (x *commitServiceGetTreeEntriesBySelectorClient) Recv() (*GetTreeEntriesBySelectorResponse, error) {
	m := new(GetTreeEntriesBySelectorResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *commitServiceClient) ListFiles(ctx context.Context, in *ListFilesRequest, opts ...grpc.CallOption) (CommitService_ListFilesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CommitService_serviceDesc.Streams[4], c.cc, "/gitaly.CommitService/ListFiles", opts...)
	if err != nil {
		return nil, err
	}
...
type CommitServiceServer interface {
	...
	GetTreeEntriesBySelector(*GetTreeEntriesBySelectorRequest, CommitService_GetTreeEntriesBySelectorServer) error
...
func _CommitService_GetTreeEntriesBySelector_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetTreeEntriesBySelectorRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CommitServiceServer).GetTreeEntriesBySelector(m, &commitServiceGetTreeEntriesBySelectorServer{stream})
}

type CommitService_GetTreeEntriesBySelectorServer interface {
	Send(*GetTreeEntriesBySelectorResponse) error
	grpc.ServerStream
}

type commitServiceGetTreeEntriesBySelectorServer struct {
	grpc.ServerStream
}

func (x *commitServiceGetTreeEntriesBySelectorServer) Send(m *GetTreeEntriesBySelectorResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _CommitService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetTreeEntriesBySelector",
			Handler:       _CommitService_GetTreeEntriesBySelector_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor1 = []byte{
	...
	,
}
