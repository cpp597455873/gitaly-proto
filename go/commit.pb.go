...
func (*GetCommitRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{37} }

func (m *GetCommitRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *GetCommitRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GetCommitRequest)(nil), "gitaly.GetCommitRequest")
...
type CommitServiceClient interface {
	...
	GetCommit(ctx context.Context, in *GetCommitRequest, opts ...grpc.CallOption) (*GitCommit, error)
}
...
func (c *commitServiceClient) GetCommit(ctx context.Context, in *GetCommitRequest, opts ...grpc.CallOption) (*GitCommit, error) {
	out := new(GitCommit)
	err := grpc.Invoke(ctx, "/gitaly.CommitService/GetCommit", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommitServiceServer interface {
	...
	// Find Commit by object id
	GetCommit(context.Context, *GetCommitRequest) (*GitCommit, error)
}
...
func _CommitService_GetCommit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitaly.CommitService/GetCommit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptor1 = []byte{
	...
	,
}
