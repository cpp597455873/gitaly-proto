...
func (*RepositoryExistsRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*RepositoryExistsResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func init() { proto.RegisterFile("repository-service.proto", fileDescriptor4) }
