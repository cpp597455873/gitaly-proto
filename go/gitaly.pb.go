...
type FindRefNamesResponse struct {
...
func (m *FindRefNamesResponse) Reset()                    { *m = FindRefNamesResponse{} }
func (m *FindRefNamesResponse) String() string            { return proto.CompactTextString(m) }
func (*FindRefNamesResponse) ProtoMessage()               {}
func (*FindRefNamesResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }

func (m *FindRefNamesResponse) GetNames() []byte {
	if m != nil {
		return m.Names
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*FindRefNamesResponse)(nil), "gitaly.FindRefNamesResponse")
...
type RefClient interface {
	...
	FindRefName(ctx context.Context, in *FindRefNameRequest, opts ...grpc.CallOption) (*FindRefNamesResponse, error)
}
...
func (c *refClient) FindRefName(ctx context.Context, in *FindRefNameRequest, opts ...grpc.CallOption) (*FindRefNamesResponse, error) {
	out := new(FindRefNamesResponse)
...
type RefServer interface {
	// Find a Ref matching the given constraints. Response may be empty.
	FindRefName(context.Context, *FindRefNameRequest) (*FindRefNamesResponse, error)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
